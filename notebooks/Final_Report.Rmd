--- 
title: "In Touch With Their Emotions: The effect of emotional content in episodes of the TV show *Friends* on US viewership"
...
```{r -- Number of Views per Episode, echo=FALSE}
library(ggplot2)
library(plotly)
...
```{r -- Barplot of Total Counts of Each Emotion, echo = FALSE}
...
library(tidyverse)
ggplot(data = full_emotions, aes(x=episode_index, fill = emotion)) + geom_bar() + ggtitle("FRIENDS: Number of lines in each episode, stacked by emotion")
